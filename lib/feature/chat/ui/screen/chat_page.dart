...
class _ChatPageState extends State<ChatPage> {
  final FirebaseChatOperation f = FirebaseChatOperation();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      f.markMessagesAsRead(widget.chatId);
    });
      ...
      body: Column(
        children: [
          TopCahtPage(
            ...
            firebaseChatOperation: f,
          ),
          // Expanded area for the chat messages (empty for now)
          Expanded(
              child: StreamBuilder<List<MessageModel>>(
                  stream: f.getMassage(chatId: widget.chatId),
                      ...
                      if (snapshot.hasData) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            log("current id---->${f.firebaseService.getFirebaseUserId()}");
                            return Column(
                              children: [
          ...
          MessageInputWidget(
            ...
            usersendId: f.firebaseService.getFirebaseUserId(),
